                  ...
                  <div className="p-5 space-y-3 max-h-[70vh] overflow-auto">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      {(() => {
                        ...
                        //     super-admin / user with "Edit Inventory" permission
                        //     (which triggers an adjustment journal entry).
                        // S22.9 (Apr 23 2026) — per Max: "unless a super admin
                        // or permissioned to change it". Widened the unlock
                        // gate to also accept modulePerms['Edit Inventory'].
                        ...
                        const existingForCurr = formData.prodId
                          ...
                          : null;
                        const canOverrideQty = userProfile?.role === 'super_admin' || modulePerms?.['Edit Inventory'] === true;
                        ...
                        return (<>
                          ...
                          <div>
                            ...
                            {qtyLocked && (
                              <div className="text-[10px] text-slate-400 mt-1">Locked — ask a super-admin or someone with "Edit Inventory" permission.</div>
                            )}
                      ...
                      <button onClick={async () => {
                        try {
                          ...
                          if (isFirstTime) {
                            ...
                            // S22.9 — super-admin OR anyone with "Edit Inventory"
                            // perm may override Original/Current; everyone else
                            // can only set the Inbound amount.
                            const canOverrideQty = isSuperAdmin || modulePerms?.['Edit Inventory'] === true;
                            if (canOverrideQty) {
                            ...
                            if (inboundQty === 0 && adjustmentsToLog.length === 0) {
                              alert('Nothing to save. Enter an Inbound Quantity, or (if you have Edit Inventory permission) change Original/Current with a reason.');
                              return;
                            }
                          }
