...
**HEAD = v55.83-KX.** runner 54/54; build clean. The whole in-screen Wave connect flow + your KW/KT findings are CLOSED IN CODE; remaining work is LIVE (your "do not claim connected until live-verified" caution — agreed, I keep telling Max to click + report).
