...
ok('1a: StatCard label uses inline true-black style (HOTFIX 17: even stronger than slate-900)',
  /color: '#0f172a'/.test(ab) && /font-black uppercase tracking-wide[\s\S]{0,150}props\.label/.test(ab));
