...
// Era: S17.8 (Apr 2026)
// Reason: tested dashboard-pin behavior with max-md:order-last + tab!==dashboard gating — both removed
//
...
// subsystem.
console.log('⚠️  test-s17-8-dashboard-nadia-pin.js RETIRED — architecture changed');
process.exit(0);
