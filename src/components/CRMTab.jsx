          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div><label className="text-[10px] font-semibold">Phone</label>
              {canSeeContact(sel) ? (
                ...
                <div className="w-full px-2 py-1.5 border rounded text-sm bg-slate-50 text-slate-600">🔒 {maskPhone(sel.phone)}</div>
              )}</div>
            <div><label className="text-[10px] font-semibold">Email</label>
              {canSeeContact(sel) ? (
                ...
                <div className="w-full px-2 py-1.5 border rounded text-sm bg-slate-50 text-slate-600">🔒 {maskEmail(sel.email)}</div>
              )}</div>
            <div><label className="text-[10px] font-semibold">City</label>
              {canSeeContact(sel) ? (
                ...
                <div className="w-full px-2 py-1.5 border rounded text-sm bg-slate-50 text-slate-600">🔒 City restricted</div>
              )}</div>
