...
export const BUILD_HISTORY = [
  {
    ...
    items: [
      '**🩹 HOTFIX 26 (May 28 2026):** El Sayad bill INV-EL-SAYAD-2026-003 was showing $17K+ open balance when it should have been ~$6.7K. Per Max screenshot, real money bug in the FIFO allocator that I had previously certified as correct.',
      '   • **The asymmetry:** payment_sent and payment_received both first walk the open bills/invoices list and apply the cash, then put any leftover into the prepaid pool. credit_adjustment was different — it parked the entire amount directly into prepaid without first paying down any open items. That meant a $10,609.90 Algeria-commission credit sat unused beside a $151K open bill, when economically it should have paid the bill down.',
      '   • **Why it was hard to spot:** the OVERALL net balance was correct either way. The math (Total AR − their prepaid) − (Total AP − our prepaid) cancels regardless of which side a credit lives on. So summary cards looked fine while per-row Open Balance lied — overstating what you owed on individual bills and overstating the prepaid pool by the same amount.',
      '   • **The fix:** credit_adjustment now drains the same open pool that a payment would — debit_amount drains open bills first then any excess goes to ourPrepaid; credit_amount drains open invoices first then any excess goes to theirPrepaid. Symmetric with payment_sent and payment_received.',
      '   • **Impact on your data:** the El Sayad USD per-row Open Balance for bill INV-EL-SAYAD-2026-003 now correctly shows around $11,720 remaining (the credit fully applied), the Our Prepaid pot drops to $0, and the net balance stays the same.',
      '   • **Pinned by behavioral test:** the regression suite now spawns the FIFO simulator with the exact Max scenario and fails the build if any of these four guarantees break — credit gets applied to the open bill, prepaid pool sits at $0, bill open remaining lands at the expected value, and net balance equals bill remaining.',
