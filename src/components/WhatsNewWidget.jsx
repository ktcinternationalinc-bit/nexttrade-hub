...
export const BUILD_HISTORY = [
  {
    ...
    items: [
      '**🩹 HOTFIX 11 (May 26 2026):** Open Accounts table fully rebuilt to standard accounting layout after iterating with Max and a third-party review pass, then a final polish pass:',
      ...
      '   • **NO double-counted totals.** The AR Side and AP Side columns are NOT summed in the totals row. Earlier iterations were adding "Sales Invoice + Payment Received" together, which is mathematically meaningless because the payment is just settling the invoice — the same economic event twice. The Summary block only sums what is meaningful: Open AR (unpaid invoices) and Open AP (unpaid bills).',
      ...
      '   • Tests: 47 assertions covering all helpers, table headers, per-row routing, Summary block structure, Net Position arithmetic, "in our favor / against us" sub-labels, FX conversion (with the spec example: USD −2,876 + EGP −20,500 ÷ 50 = USD −3,286 global net), and print + Excel exports.',
