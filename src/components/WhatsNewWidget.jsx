...
export const BUILD_HISTORY = [
  {
    ...
    items: [
      ...
      '**Cleanup:** removed about 115 lines of dead variant-modal code from the Product List page. That code path was orphaned in v55.83-A.6.27.42 when "Clone Template" replaced it, but the unused state + helpers + modal JSX were still hanging around. Cleaner file, no behavior change.',
  ...
  },
  {
    ...
    items: [
      ...
      '**Coming next:** Customer-level KPI dashboard. FX snapshot backfill SQL. Dead-code cleanup.',
  ...
  },
  {
    ...
    items: [
      ...
      '   • The FX P&L report no longer silently treats USD costs as EGP when there\'s no exchange-rate snapshot. It now converts through whatever FX rate is on file for that date — or flags the row "unconvertable" if no rate exists. Critical fix: this bug could have made profit numbers off by 50× without you knowing.',
