...
var REQUIRED = {
  ...
  bank_transactions: ['wave_business_id', 'wave_account_id', 'wave_account_name', 'wave_account_type', 'wave_account_subtype', 'category_source', 'category_status', 'wave_transaction_id'],
